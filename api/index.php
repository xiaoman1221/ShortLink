...
<body class="mdui-appbar-with-toolbar  mdui-theme-primary-pink mdui-theme-accent-pink">
    ...
    <div class="mdui-container " style="max-width: 400px; ">
        ...
        <div class="mdui-card" style="border-radius: 16px;">
            ...
            <div class="mdui-card-content">
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input" id="url" placeholder="https://1v.fit" type="text" />
                </div>
                <br>
            </div>
        ...
        <footer>
            <!-- 本程序使用MIT协议开源，请遵守此协议，请勿删除本处版权，否则原作者保留一切法律权利 -->
            <center><p style="color:white;">&copy; 2017-2024 Copyright <a style="color:white;" target="_blank" href="https://studio.yhdzz.cn/">云电工作室</a></p></center>
        </footer>
